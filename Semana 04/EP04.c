...
/*
                              ATENCAO !!!
                             =============
O enunciado pede para entrar com um valor de 1 ate 10 (usando um scanf). No
entanto, utilizei um menu no lugar, para demonstrar a facilidade dos menus.
O codigo da forma que foi solicitado esta comentado nesse mesmo codigo.
*/

/////////////////////////////////////////////////////////////////
//   Codigo do problema proposto para a ENTREGA PROGRAMADA 4   //
/////////////////////////////////////////////////////////////////
/*
int main(void){
    int codigo = 0;
